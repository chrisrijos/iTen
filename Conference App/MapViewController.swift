...
class MapViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Styling
        resultLabel.textColor =  UIColor(red: 0.15, green: 0.353, blue: 0.6, alpha: 100)
        resultLabel.layer.borderColor = UIColor(red: 0.15, green: 0.353, blue: 0.6, alpha: 100).CGColor
